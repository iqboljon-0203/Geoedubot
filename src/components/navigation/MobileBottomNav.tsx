...
const MobileBottomNav = ({ role }: MobileBottomNavProps) => {
  ...
  const teacherNavItems = [
    {
      ...
      icon: (isActive: boolean) => (
        <svg className={cn("w-5 h-5", isActive && "scale-110")} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 bg-white/80 backdrop-blur-xl border-t border-zinc-200/60" />
